...
### beginner-2-take-the-last-greek-train-to-athens

* συγνώμη / συγγνώμη - I'm sorry, excuse me, I beg your pardon
* κύρια - madam
* γραμμές - tracks, lines
* πλατφόρμα - platform
* ο σταθμός - station

### Discord

#### Noun Stack / Noun Phrase

Greek uses genitive for that:

* χώρος στάθμευσης - parking space
  * ο χώρος - space
  * η στάθμευση - parking
  * literally "space of parking"
* όριο ταχύτητας - speed limit
  * η ταχύτητα - speed
  * το όριο - limit
  * literally "limit of speed"
  * Δεν πρέπει να πας γρηγορότερα από το αναγραφόμενο όριο ταχύτητας.

#### Verb to Noun Relations

* το περπάτημα - (the act or process of) walking
  * περατάω - to walk
* η μάθηση - (the act or process of) learning
  * μαθαίνω - to learn
* η οδήγηση - (the act or process of) driving
  * οδηγώ - to drive
